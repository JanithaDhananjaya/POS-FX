...
public class MainFormController implements Initializable {
    ...
    private void navigate(MouseEvent event) throws IOException {
        if (event.getSource() instanceof ImageView){
            ...
            switch(icon.getId()){
                case "imgCustomer":
                    root = FXMLLoader.load(this.getClass().getResource("/lk/ijse/fxpos/view/ManageCustomerForm.fxml"));
                    break;
                case "imgItem":
                    break;
                case "imgOrder":
                    root = FXMLLoader.load(this.getClass().getResource("/lk/ijse/fxpos/view/OrderForm.fxml"));
                    break;
                case "imgSettings":
                    break;
            }
